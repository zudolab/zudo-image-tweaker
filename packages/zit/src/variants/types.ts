...
export interface ProcessOneConfig {
  ...
  autoRepair?: boolean;
  /** Bake EXIF orientation into pixels (and drop metadata) before encoding. @default false */
  bakeExifOrientation?: boolean;
  /** Strip all metadata before encoding (subsumed by bakeExifOrientation). @default false */
